...
import com.gaode.HelloFragment;
...
public abstract class MyActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IMIndoorMapFragment viewFragment = new IMIndoorMapFragment();
        getSupportFragmentManager().beginTransaction().add(viewFragment,"hellocomponent").commit();
    }
