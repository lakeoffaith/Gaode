...
public class TimePickerDialogModule extends ReactContextBaseJavaModule {
  ...
  @VisibleForTesting
  public static final String FRAGMENT_TAG = "Indoor";
  ...
  public void open(@Nullable final ReadableMap options, Promise promise) {
    ...
    if (activity instanceof android.support.v4.app.FragmentActivity) {
      ...
      com.facebook.react.modules.timepicker.SupportTimePickerDialogFragment fragment = new com.facebook.react.modules.timepicker.SupportTimePickerDialogFragment();
      if (options != null) {
      ...
      com.facebook.react.modules.timepicker.TimePickerDialogFragment fragment = new TimePickerDialogFragment();
      if (options != null) {
